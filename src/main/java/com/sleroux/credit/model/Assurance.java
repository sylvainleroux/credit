...
public class Assurance {
	...
	public BigDecimal getMensualite() {
		...
		return capital.multiply(taux).multiply(new BigDecimal((int) nbPeriodes / 12)).divide(new BigDecimal(nbPeriodes), RoundingMode.HALF_UP)
